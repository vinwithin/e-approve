      ...
      <div className="flex max-w-screen-sm max-h-max flex-1 flex-col px-6 py-12 mx-auto my-auto bg-[#dea6f7] drop-shadow-2xl rounded-lg">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            ...
            <div >
                <span><a className="text-sm font-medium leading-6 text-dark">Have an Account?</a><a href="/login" className="text-sm font-medium leading-6 text-blue-700">&nbsp;Login</a></span>
            </div>
            <div>
              <button
                type="submit"
